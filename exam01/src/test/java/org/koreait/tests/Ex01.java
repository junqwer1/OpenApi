...
public class Ex01 {
    ...
    void init() {
        om = new ObjectMapper();
        om.registerModule(new JavaTimeModule()); //변환 작업?
    ...
    void test1() throws Exception {
        ...
        // JSON 문자열 -> 자바 객체로 변환
        RequestJoin form2 = om.readValue(json, RequestJoin.class); // 단일 클래스 형태의 자료형으로 변환시 Class 클래스가 매개변수
    ...
    @Test
    void test3() {
//        UriComponentsBuilder url = UriComponentsBuilder.fromUri(URI.create("https://naver.com"));
